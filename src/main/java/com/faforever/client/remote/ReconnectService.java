...
public class ReconnectService {
  ...
  private static final Random RECONNECT_RANDOM = new Random(System.currentTimeMillis());
  ...
  long getReconnectTimeOut() {
    ...
    timeToWait = timeToWait > RECONNECT_DELAY_MAX ? RECONNECT_DELAY_MAX : timeToWait;
    return (long) (RECONNECT_RANDOM.nextFloat() * timeToWait);
  }
