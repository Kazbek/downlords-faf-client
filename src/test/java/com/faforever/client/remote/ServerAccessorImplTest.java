...
public class ServerAccessorImplTest extends AbstractPlainJavaFxTest {
  ...
  public void setUp() throws Exception {
    ...
    instance = new FafServerAccessorImpl(preferencesService, uidService, notificationService, i18n, reportingService, taskScheduler, eventBus, reconnectService, clientProperties);
